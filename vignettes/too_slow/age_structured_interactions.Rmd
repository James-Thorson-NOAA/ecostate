...
out = ecostate(
  ...
  control = ecostate_control( 
    ...
    random = NULL, # Penalized likelihood so use empty set
    derived_quantities = c(), # Turn off for speed
    tmbad.sparse_hessian_compress = 0, # Turn off for speed
...
ggplot_foodweb = plot_foodweb( 
  ...
  type_i = type )
ggplot_foodweb + 
  scale_x_continuous( name = "Pelagic proportion" ) +
  scale_y_continuous( name="Trophic level" ) +
  ggtitle( "Gulf of Alaska case study") +
  theme_classic()
```
